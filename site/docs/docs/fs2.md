...
FS2 integration allows you to read and write Parquet using functional streams. Functionality is exactly the same as in the case of Pekko module. In order to use it, please import the following:
