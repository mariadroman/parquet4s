...
object PekkoBenchmark {

  val Fractioner = 100.12
  val Dict       = List("a", "b", "c", "d")
  val Dispatcher = "org.apache.pekko.actor.single-thread-dispatcher"
    ...
    def setup(): Unit = {
      ...
      actorSystem = ActorSystem(
        ...
        ConfigFactory.parseString(
          """
            org.apache.pekko.actor.single-thread-dispatcher {
  ...
  class WriteState extends BaseState {
    ...
    @CompilerControl(CompilerControl.Mode.DONT_INLINE)
    def pekkoWritePartitioned(): Record =
...
class PekkoBenchmark {

  import PekkoBenchmark.*
